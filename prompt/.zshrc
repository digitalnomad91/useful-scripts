...
#plugins=(git)
plugins=(exa-zsh git node bundler docker docker-compose rake ruby python zsh-syntax-highlighting zsh-256color nvm oh-my-matrix zsh-nvm reminder common-aliases extract sudo taskwarrior yarn-autocompletions zsh-auto-nvm-use fast-syntax-highlighting)
#zsh-bash
